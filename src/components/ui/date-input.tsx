...
const DateInput: React.FC<DateInputProps> = ({ value, onChange }) => {
  ...
  return (
    <div className="flex items-center rounded-md border border-border bg-transparent px-1 text-sm text-foreground shadow-xs">
      <input
        type="text"
        ref={dayRef}
        max={31}
        ...
        className="w-7 border-0 bg-transparent p-0 text-center text-foreground outline-none"
        placeholder="G"
      />
      ...
      <input
        ...
        className="w-6 border-0 bg-transparent p-0 text-center text-foreground outline-none"
        placeholder="A"
      />
      <span className="text-muted-foreground/50 -mx-px">/</span>
      <input
        ...
        className="w-12 border-0 bg-transparent p-0 text-center text-foreground outline-none"
        placeholder="YYYY"
      />
    </div>
  )
